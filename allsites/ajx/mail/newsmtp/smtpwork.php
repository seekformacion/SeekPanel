...
echo "dddd";
	...
	$smtp->localhost="54.194.56.56";       /* Your computer address */
	...
	$smtp->pop3_auth_host="pop3.seekformacion.com";           /* Set to the POP3 authentication host if your SMTP server requires prior POP3 authentication */
